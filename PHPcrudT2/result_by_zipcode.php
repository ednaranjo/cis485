...
<html>
    ...
    <body>
        <div id="container">
            <?php
            $zipin = htmlspecialchars($_GET["zipcode"]);

            require_once 'config.php';
            
            $conn = new mysqli($servername, $username, $password, $dbname);
            $result = mysqli_query($conn,"call GetByZipCode('".$zipin."')");
            $rowcount=mysqli_num_rows($result);
            
            echo "<h3>New York City Restaurants Report: Filter By Zip Code " . $zipin . " (".$rowcount .")</h3>";
